 ...
 *
 * Uses @traceroot/sdk with instrumentModules to auto-instrument all
 * calls through OpenRouter's OpenAI-compatible API.
 *
...
console.log('[Observability: TraceRoot + OpenRouter]');
