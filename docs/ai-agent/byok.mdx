...
OpenAI, Anthropic, Azure OpenAI, Google (Gemini), Amazon Bedrock, xAI, DeepSeek, OpenRouter, Kimi, GLM. With BYOK, additional models such as `claude-fable-5` are also selectable.
