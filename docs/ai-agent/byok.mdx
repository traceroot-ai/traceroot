...
When adding a model to an Anthropic BYOK provider, the first entry is selected by default:
...
TypeSafe AI runs detectors only; it does not appear in the chat or RCA model pickers.
