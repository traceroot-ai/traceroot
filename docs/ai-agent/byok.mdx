...
Once configured, the model selector in the AI chat interface will show both system models and your BYOK models — including BYOK-only models like OpenAI's `gpt-5.6-sol` that aren't part of the system model list above.
