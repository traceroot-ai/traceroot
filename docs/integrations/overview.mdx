...
export const IntegrationCard = ({ logo, title, href }) => (
  <a
    href={href}
  ...
  >
    <div className="shrink-0 flex items-center justify-center">
      <img src={logo} alt="" className="w-5 h-5 object-contain m-0" />
    </div>
...
<IntegrationGrid cols={2}>
  <IntegrationCard logo="/logo/integrations/python.svg" title="Python SDK" href="/tracing/python-sdk" />
  <IntegrationCard logo="/logo/integrations/typescript.svg" title="TypeScript SDK" href="/tracing/typescript-sdk" />
</IntegrationGrid>
...
<IntegrationGrid cols={3}>
  ...
  <IntegrationCard logo="/logo/integrations/autogen.svg" title="AutoGen (AG2)" href="/integrations/autogen" />
  ...
  <IntegrationCard logo="/logo/integrations/google-adk.svg" title="Google ADK" href="/integrations/google-adk" />
  <IntegrationCard logo="/logo/integrations/langchain.svg" title="LangChain & LangGraph" href="/integrations/langchain" />
  <IntegrationCard logo="/logo/integrations/langchain-deepagents.svg" title="LangChain DeepAgents" href="/integrations/langchain-deepagents" />
  <IntegrationCard logo="/logo/integrations/llamaindex.png" title="LlamaIndex" href="/integrations/llamaindex" />
  <IntegrationCard logo="/logo/integrations/mastra.svg" title="Mastra" href="/integrations/mastra" />
  <IntegrationCard logo="/logo/integrations/openai-agents-sdk.svg" title="OpenAI Agents SDK" href="/integrations/openai-agents-sdk" />
  <IntegrationCard logo="/logo/integrations/vercel-ai.svg" title="Vercel AI SDK" href="/integrations/vercel-ai" />
</IntegrationGrid>
...
<IntegrationGrid cols={3}>
  <IntegrationCard logo="/logo/integrations/anthropic.svg" title="Anthropic" href="/integrations/anthropic" />
  ...
  <IntegrationCard logo="/logo/integrations/openai.svg" title="OpenAI" href="/integrations/openai" />
</IntegrationGrid>
