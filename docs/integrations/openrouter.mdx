...
| Cost       | Calculated when the routed model ID matches TraceRoot's pricing table (for example, supported `openai/...`, `anthropic/...`, or `google/...` IDs); otherwise tokens are captured without cost |
