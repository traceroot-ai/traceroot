...
Install TraceRoot with the Agent Framework extra:

```bash
pip install "traceroot[agent-framework]" agent-framework-openai
```

This extra installs the OpenInference instrumentor and requires OpenTelemetry
1.39 or newer.
