...
To see what's published without pulling it, the [CLI](/evals/cli) lists datasets, their versions, and the cases in one version:

```bash
traceroot datasets list
traceroot datasets versions list ds_…
traceroot datasets versions get dsv_…
```
...
<CardGroup cols={2}>
  ...
  <Card title="From the Terminal" icon="terminal" href="/evals/cli">
    Read datasets and their versions with the CLI.
  </Card>
</CardGroup>
