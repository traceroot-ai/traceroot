...
export async function getProject(projectId: string): Promise<Project> {
  return fetchNextApi<Project>(`/projects/${projectId}`);
}
...
export async function updateApiKey(
  ...
  return fetchPythonApi<ApiKey>(`/projects/${projectId}/api-keys/${keyId}`, {
    method: "PUT",
    body: JSON.stringify({ name }),
  });
}
...
export async function getTrace(
  ...
  return fetchPythonApi<TraceDetail>(`/projects/${projectId}/traces/${traceId}`);
}
