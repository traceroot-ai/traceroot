...
CREATE TABLE "detector_alert_configs" (
    "id" VARCHAR NOT NULL,
    "detector_id" VARCHAR NOT NULL,
    "auto_rca" BOOLEAN NOT NULL DEFAULT true,
...
-- CreateIndex
CREATE UNIQUE INDEX "detector_alert_configs_detector_id_key" ON "detector_alert_configs"("detector_id");
...
-- AddForeignKey
ALTER TABLE "detector_alert_configs" ADD CONSTRAINT "detector_alert_configs_detector_id_fkey" FOREIGN KEY ("detector_id") REFERENCES "detectors"("id") ON DELETE CASCADE ON UPDATE CASCADE;
