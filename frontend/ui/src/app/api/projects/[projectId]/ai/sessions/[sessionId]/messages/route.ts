...
import { requireAuth, requireProjectAccess, successResponse, errorResponse } from "@/lib/auth-helpers";
...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  ...
  if (accessResult.error || !accessResult.project) return accessResult.error || errorResponse("Project not found", 404);
