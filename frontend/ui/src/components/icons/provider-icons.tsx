...
// TypeSafe AI (official mark and brand pink from typesafe.ai)
export const TypeSafeIcon: FC<IconProps> = ({ className }) => (
  <svg
    viewBox="0 0 24 24"
    className={cn("h-4 w-4", className)}
    xmlns="http://www.w3.org/2000/svg"
    aria-hidden="true"
  >
    <rect width="24" height="24" rx="4" fill="#E551BA" />
    <g fill="#171717" transform="translate(6.5,4) scale(0.6667)">
